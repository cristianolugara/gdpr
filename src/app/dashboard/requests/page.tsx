...
// Mock Data
const MOCK_REQUESTS: GdprSubjectRequest[] = [
    {
        id: "REQ-001",
        companyId: "COMP-123",
        type: "ACCESS",
        ...
        deadlineDate: "2024-11-25T10:00:00Z",
    ...
    },
    {
        ...
        requesterEmail: "luigi.v@example.com",
        requestDate: "2024-10-20T14:30:00Z",
        deadlineDate: "2024-11-20T14:30:00Z",
        isIdentityVerified: false,
        notes: "Richiesta documento identità inviata il 21/10",
    ...
    },
    {
        ...
        type: "RECTIFICATION",
        status: "COMPLETED",
        requesterName: "Giulia Bianchi",
        requesterEmail: "g.bianchi@test.it",
        requestDate: "2024-10-01T09:15:00Z",
        deadlineDate: "2024-10-31T09:15:00Z",
        isIdentityVerified: true,
        responseDocumentUrl: "/docs/replies/req-003.pdf",
...
export default function RequestsPage() {
    const [requests, setRequests] = useState<GdprSubjectRequest[]>(MOCK_REQUESTS)
                            ...
                            <div>
                                ...
                                <div className="rounded-md border bg-slate-50 p-4 text-sm font-mono dark:bg-slate-950 dark:border-slate-800 max-h-60 overflow-y-auto whitespace-pre-wrap">
                                    {GDPR_TEMPLATES[selectedRequest.type]?.content
                                        ...
                                        .replace('{{companyName}}', 'Antigravity S.r.l.') // Mock
                                        .replace('{{handlerName}}', 'Cristiano Lugarà') // Mock
                                        .replace('{{handlerPosition}}', 'Amministratore')
                                    }
                                </div>
                            </div>
                        </div>
